...
static int bnx2x_multi_mode = 1;
module_param_named(multi_mode, bnx2x_multi_mode, int, 0);
MODULE_PARM_DESC(multi_mode, " Obsolete parameter");
...
static DECLARE_MUTEX(bnx2x_prev_sem);
...
static struct pci_driver_rh bnx2x_pci_driver_rh = {
#ifdef CONFIG_BNX2X_SRIOV
...
static struct pci_driver bnx2x_pci_driver = {
	...
	.rh_reserved = &bnx2x_pci_driver_rh,
...
static int __init bnx2x_init(void)
{
	...
	if (bnx2x_multi_mode != 1)
		pr_warn("Module parameter multi_mode is obsolete. Ignoring.\n");
